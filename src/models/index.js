...
routes.get('/register', ensureAuth, ensureAdmin, Auth.registerForm);
routes.post('/register', ensureAuth, ensureAdmin, Auth.register);
...
routes.post('/tickets/:id/comments', ensureAuth, Ticket.addComment);
